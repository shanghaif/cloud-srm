...
import com.midea.cloud.flow.workflow.mapper.TemplateLinesMapper;
...
*/
@Service
public class TemplateLinesServiceImpl extends ServiceImpl<TemplateLinesMapper, TemplateLines>
        implements ITemplateLinesService {
}
