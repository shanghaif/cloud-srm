...
/**
 * 工作流操作，只用于自带界面模式的话，对于自带页面的情况，所有界面操作都独立的类中实现，因为这是只有这个模式特有的，不要和WorkflowHandlerServiceImpl一起，在这里实现适配第三方工作流
 * @author lizl7
 *
 */
@RestController
...
//	 * @return
//	 */
//	@PostMapping(value = "submitObjEntry")
//	private String submitObjEntry(Long businessId, String businessIdType) throws Exception{
//		return null;
//	}
//	
//	/**
...
//	 * @return
//	 */
//	@PostMapping(value = "auditObjEntry")
//	private String auditObjEntry(Long businessId, String businessIdType) throws Exception{
//		return null;
//	}
//	
//	
...
//	 * @throws Exception
//	 */
//	@PostMapping(value = "queryFlowNodeForCommitEntry")
//	public String queryFlowNodeForCommitEntry(String businessId, String businessType, String businessVariables) throws Exception {
//		return null;
//	}
//	
//	/**
...
//	public String queryFlowInstanceBusinessBy(String businessId,String businessType) throws Exception{
//		return null;
//	}
//	
//	/**
