package com.midea.cloud.common.utils.jwt;
...
public class JwtUtil {
    ...
    public static void main(String[] args) {
        String jwt = JwtUtil.createJWT("1234567", 6000000, "admin"); // 10秒过期
        System.out.println(jwt); // 生成token
        System.out.println(parseJWT("1234567", jwt)); // 解析token
    }
