...
public enum VendorImportStatus {
    ...
    private VendorImportStatus(String name, String value) {
        this.name = name;
        this.value = value;
    }
     ...
     * @return
     */
    public static VendorImportStatus get(String value ){
        for(VendorImportStatus o:VendorImportStatus.values()){
