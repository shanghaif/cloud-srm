...
public interface ICalculateIndividualPriceScoreService extends ICalculatePriceScoreService {
    ...
    default void calculateAndSetIndividualPrice(Collection<OrderLine> orderLines) {
        ...
        orderLines.forEach(orderLine -> {
            BigDecimal discountPrice = evaluationServiceSupplier.get().calculateDiscountPrice(orderLine, bidding.getMonthlyInterest(), Objects.equals(bidding.getEvaluateMethod(), EvaluateMethod.HIGH_PRICE.getItemValue())
