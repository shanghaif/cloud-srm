...
import com.midea.cloud.srm.bargaining.suppliercooperate.projectlist.mapper.BidSignUpMapper;
...
import com.midea.cloud.srm.feign.bargaining.BidOrderLineFormulaPriceDetailClient;
...
import com.midea.cloud.srm.model.bargaining.suppliercooperate.vo.BidOrderLineExportVO;
import com.midea.cloud.srm.model.bargaining.suppliercooperate.vo.BidOrderLineImportVO;
...
public class BidSignUpServiceImpl extends ServiceImpl<BidSignUpMapper, SignUp> implements IBidSignUpService {
    ...
    private void checkData(Long bidingId, List<BidOrderLineImportVO> bidOrderLineImportVOS, AtomicBoolean flag,
