package com.midea.cloud.srm.bargaining.purchaser.projectmanagement.signupmanagement.service.impl;
...
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.signupmanagement.mapper.SignUpManagementMapper;
		...
		if (BidingScope.INVITE_TENDER.getValue().equals(biding.getBidingScope()) && "Y".equals(biding.getReleaseFlag())) {
			...
			for (SignUp tempSignUp : signUpList) {
				...
				vo.setRejectReason(tempSignUp.getRejectReason()).setSignUpStatus(tempSignUp.getSignUpStatus()).
						...
						.setIfDeposit(tempSignUp.getIfDeposit());
				voList.add(vo);
			}
		}
