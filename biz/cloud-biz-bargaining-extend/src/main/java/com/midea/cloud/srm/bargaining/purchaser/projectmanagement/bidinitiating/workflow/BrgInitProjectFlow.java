package com.midea.cloud.srm.bargaining.purchaser.projectmanagement.bidinitiating.workflow;

import com.alibaba.fastjson.JSONObject;
import com.midea.cloud.common.utils.AppUserUtil;
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.bidinitiating.controller.BidFileConfigController;
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.bidinitiating.controller.BidFileController;
 ...
 */
@RestController
@RequestMapping("/brgFLow")
public class BrgInitProjectFlow {
    ...
    @Value("${template.brgInitProjectTempId}")
    private String tempId;

    @Value("${template.brgInitProjectSrmLink}")
    private String srmLink;

//    private String tempId = "175628784ff0eb21112d0ef4f4e9a36e";
//    private String srmLink = "http://10.0.10.48/#/formDataPreview?funName=biddingProject_new&formId=$formId$";
     ...
     * </pre>
     */
    @PostMapping(value = "/submitBrgFlow")
    public String submitBrgInitProjectConfFlow(@RequestBody Biding biding) throws Exception {
        ...
        String formId = "";
        String docSubject = "询比价文件审批_" + biding.getBidingNum();
