package com.midea.cloud.srm.bargaining.purchaser.projectmanagement.signupmanagement.controller;
...
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.bidinitiating.mapper.BidFileConfigMapper;
...
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.signupmanagement.service.ISignUpManagementService;
...
import com.midea.cloud.srm.model.bargaining.purchaser.projectmanagement.signupmanagement.vo.SignUpBaseInfoVO;
import com.midea.cloud.srm.model.bargaining.purchaser.projectmanagement.signupmanagement.vo.SignUpFileVO;
import com.midea.cloud.srm.model.bargaining.purchaser.projectmanagement.signupmanagement.vo.SignUpInfoVO;
...
public class SignUpManagementController extends BaseController {
    ...
    public SignUpInfoVO getTechInfo(Long bidingId, Long vendorId) {
        Assert.notNull(bidingId, "招标id不能为空");
        Assert.notNull(vendorId, "供应商id不能为空");
        ...
        List<SignUpFileVO> signUpFileVOList = files.stream()
                .filter(e -> Objects.nonNull(e.getVendorReferenceFileId()))
                .map(e -> {
    ...
    public void updateSignInfo(@RequestBody SignUp signUp) {
        iSignUpService.update(new SignUp().setIfDeposit(signUp.getIfDeposit()),
                new UpdateWrapper<SignUp>().setEntity(new SignUp().setSignUpId(signUp.getSignUpId())));
    }
}
