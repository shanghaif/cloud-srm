...
import com.midea.cloud.srm.bargaining.purchaser.projectmanagement.techproposal.mapper.BidOrderLineFormulaPriceDetailMapper;
...
public class BidOrderLineFormulaPriceDetailServiceImpl extends ServiceImpl<BidOrderLineFormulaPriceDetailMapper, BidOrderLineFormulaPriceDetail> implements IBidOrderLineFormulaPriceDetailService {
    ...
    public void saveDetails(List<BidOrderLineFormulaPriceDetail> details) {
        ...
        // 存储 供应商投标行[公式报价]明细集
        formulaPriceDetailDao.useInterceptor()
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCommit() {
                ...
                for (Long id : ids) {
                    ...
                    BigDecimal lineTotalPrice = result.getValue();
                    PricingFormulaCalculateParameter parameter = result.getCalculateParameter();
                    OrderLine orderLine = new OrderLine()
                            .setOrderLineId(id)
                            .setFormulaResult(JSON.toJSONString(parameter))
                            .setPrice(lineTotalPrice);
    ...
    public void saveDetails(FormulaCalculateParam param) {
        List<BidOrderLineFormulaPriceDetail> details = param.getBrgDetails();
...
//                    orderHeadService.updateOrderLinePrice(id, lineTotalPrice);
                ...
                if (Objects.equals(param.getSourcingType(), com.midea.cloud.srm.model.inq.price.enums.SourcingType.RFQ.getItemValue()) && !Objects.equals(requirementLine.getIsSeaFoodFormula(), "Y")) {
    ...
    public PricingFormulaCalculateResult calculateOrderLineTaxTotalPrice(Long lineId, Map<Long, BaseMaterialPriceVO> collect) {
        ...
        PricingFormulaCalculateParameter calculateParameter = findDetailsByLineId(lineId).stream()
                ...
                .map(detail -> PricingFormulaCalculateParameter.from(
                        SourcingType.BARGAINING, materialItem,
