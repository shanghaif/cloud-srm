 ...
 *  修改后版本:
 *  修改人:
 *  修改日期: 2020/10/18 16:08
 *  修改内容:
 * </pre>
 */
public class PushVendorContactCallBack implements RepushCallbackService<VendorContactOutputParameters> {

    @Override
    public Boolean callback(VendorContactOutputParameters result, Object... otherService) {
        String returnStatus = "";
