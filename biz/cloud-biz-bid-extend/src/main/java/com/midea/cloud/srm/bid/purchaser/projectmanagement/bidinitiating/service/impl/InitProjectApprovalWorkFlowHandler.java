...
@Slf4j
public class InitProjectApprovalWorkFlowHandler extends WorkFlowFunctionHandler {
    ...
    public Map<String, Object> draftEvent(Long businessId, Map<String, Object> mapEventData) throws Exception {
        ...
        if (null != businessId) {
            ...
            if (biding != null && null != mapEventData) {
                biding.setInitCbpmInstanceId(String.valueOf(mapEventData.get("processId")));
        ...
        if (null != businessId) {
            ...
            if (biding != null) {
                ...
                if (bodyMap != null && null != bodyMap.get("processParam")) {
                    ...
                    biding.setInitCbpmInstanceId(String.valueOf(processParamMap.get("processId")));
                    biding.setAuditStatus(BiddingApprovalStatus.SUBMITTED.getValue());
                    biding.setPreparedBy(String.valueOf(processParamMap.get("handlerId")));
                    biding.setLastUpdateDate(new Date());
                    biding.setLastUpdatedBy(String.valueOf(processParamMap.get("handlerId"))); //登录名
    ...
    public String processEndEvent(Long businessId, Map<String, Object> mapEventData) throws Exception {
        ...
        if (null != businessId) {
            ...
            if (null != bodyMap && null != bodyMap.get("processParam")) {
                Map<String, Object> processParamMap = (Map<String, Object>) bodyMap.get("processParam");
                biding.setApprovedBy(String.valueOf(processParamMap.get("handlerId")));
    ...
    public String handleRefuseEvent(Long businessId, Map<String, Object> mapEventData) throws Exception {
        ...
        if (businessId != null) {
            ...
            if (null != biding) {
                ...
                if (bodyMap != null && null != bodyMap.get("processParam")) {
                    Map<String, Object> processParamMap = (Map<String, Object>) bodyMap.get("processParam");
                    biding.setAuditStatus(BiddingApprovalStatus.REJECTED.getValue());
