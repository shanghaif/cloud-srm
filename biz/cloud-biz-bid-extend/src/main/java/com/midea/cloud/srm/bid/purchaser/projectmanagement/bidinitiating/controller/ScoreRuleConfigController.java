...
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.evaluation.vo.ScoreRuleConfigVO;
...
public class ScoreRuleConfigController extends BaseController {
    ...
    */
    ...
    public PageInfo<ScoreRuleConfig> listPage(@RequestBody ScoreRuleConfig scoreRuleConfig) {
        ...
        String enableFlag = scoreRuleConfig.getEnableFlag();
        String ruleConfigName = scoreRuleConfig.getRuleConfigName();

        if (!StringUtils.isEmpty(scoreRuleConfig.getEnableFlag())){
            enableFlag = scoreRuleConfig.getEnableFlag();
            scoreRuleConfig.setEnableFlag(null);
        }
        if (!StringUtils.isEmpty(scoreRuleConfig.getRuleConfigName())){
            ruleConfigName = scoreRuleConfig.getRuleConfigName();
            scoreRuleConfig.setRuleConfigName(null);
        }
        ...
        if (!StringUtils.isEmpty(ruleConfigName)){
            wrapper.eq("RULE_CONFIG_NAME", ruleConfigName);
        }
