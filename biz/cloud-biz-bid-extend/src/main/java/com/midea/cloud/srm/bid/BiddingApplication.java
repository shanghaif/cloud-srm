package com.midea.cloud.srm.bid;
...
@EnableEurekaClient
@SpringBootApplication(scanBasePackages = {"com.midea.cloud.srm.bid", "com.midea.cloud.component","com.midea.cloud.common","com.midea.cloud.log"})
@MapperScan(basePackages = {"com.midea.cloud.srm.bid.**.mapper"})
@EnableOpLog
