package com.midea.cloud.srm.bid.purchaser.projectmanagement.bidingresult.service;
...
public interface IBidingResultService extends IService<BidResult> {
    ...
    PageInfo<EvaluationResult> getNewResultByBidingId(Map<String,Object> map);
