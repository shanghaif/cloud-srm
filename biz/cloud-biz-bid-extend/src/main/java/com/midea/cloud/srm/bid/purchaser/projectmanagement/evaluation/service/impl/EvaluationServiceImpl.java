...
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.enums.PaymentProvisionType;
...
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.evaluation.vo.EvaluationResultDto;
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.evaluation.vo.EvaluationResultImportDto;
...
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.techproposal.vo.BidOrderLineTemplateTempReportVO;
import com.midea.cloud.srm.model.bid.purchaser.projectmanagement.techproposal.vo.TemplateVendorPriceVO;
...
//                }
    ...
    public List<EvaluationResult> findEvaluationResults(EvaluationQueryParam queryParam) {
        ...
        // 获取 招标轮次
        if(ObjectUtils.isEmpty(queryParam.getRound())) {
            queryParam.setRound(bidding.getCurrentRound());
        }
