...
public class OrderDetailServiceImpl implements IOrderDetailService {
	...
	public void closeOrderDetail(List<Long> ids) {
		List<OrderDetail> detailListByIds = scIOrderDetailService.listByIds(ids);
		for (OrderDetail orderDetail : detailListByIds) {
			orderDetail.setOrderDetailStatus(PurchaseOrderRowStatusEnum.CLOSED.getValue());
		}
		scIOrderDetailService.updateBatchById(detailListByIds);
	}
	...
	public PageInfo<OrderDetailDTO> listInDeliveryNotice(OrderDetailDTO orderDetailDTO) {
		...
		return scIOrderDetailService.listInDeliveryNotice(orderDetailDTO);
//		return supcooperateClient.listInDeliveryNotice(orderDetailDTO);
	}
