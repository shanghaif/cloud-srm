...
public class DeliveryNoteDetailController extends BaseController {
    ...
    public PageInfo<DeliveryNoteDetailDTO> listPage(@RequestBody DeliveryNoteRequestDTO deliveryNoteRequestDTO) {
        ...
        return new PageInfo<DeliveryNoteDetailDTO>(scIDeliveryNoteDetailService.listDeliveryNoteDetail(deliveryNoteRequestDTO));
    }
    ...
    public PageInfo<DeliveryNoteDetailDTO> listInWarehouseReceipt(@RequestBody DeliveryNoteRequestDTO deliveryNoteRequestDTO){
        return scIDeliveryNoteDetailService.listInWarehouseReceipt(deliveryNoteRequestDTO);
    }
    ...
    public PageInfo<DeliveryNoteDetailDTO> listInReturnOrder(@RequestBody DeliveryNoteRequestDTO deliveryNoteRequestDTO){
        return scIDeliveryNoteDetailService.listInReturnOrder(deliveryNoteRequestDTO);
    }
}
