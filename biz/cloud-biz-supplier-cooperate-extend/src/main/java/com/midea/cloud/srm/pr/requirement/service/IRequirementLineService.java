...
//    List<RequirementLine> importExcelInfo(List<Object> list);
     ...
     * @return
     */
    List<OrderDetail> getRequirementQuantityForOrderCheck(List<OrderDetail> detailList);

    PageInfo<RequirementLine> listPageRequirementChart(RequirementHeadQueryDTO requirementHeadQueryDTO);
