...
public class DivisionCategoryController extends BaseController {
     ...
     * @return
     */
    @GetMapping("/queryCategoryIdByUserId")
    public List<Long> queryCategoryIdByUserId(@RequestParam("userId") Long userId){
        return iDivisionCategoryService.queryCategoryIdByUserId(userId);
    }
     ...
     * @return
     */
    @PostMapping("/queryDivisionCategory")
    public PageInfo<DivisionCategory> queryDivisionCategory(@RequestBody DivisionCategory divisionCategory){
        return iDivisionCategoryService.queryDivisionCategory(divisionCategory);
    }
}
