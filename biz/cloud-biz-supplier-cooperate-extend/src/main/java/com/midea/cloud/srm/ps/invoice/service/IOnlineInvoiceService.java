...
public interface IOnlineInvoiceService {
    ...
    void abandon(Long onlineInvoiceId);
    ...
    FSSCResult batchSubmit(List<Long> onlineInvoicIds);

    void onlineInvoiceWithdraw(Long onlineInvoiceId);

    Long restart(Long onlineInvoiceId);
}
