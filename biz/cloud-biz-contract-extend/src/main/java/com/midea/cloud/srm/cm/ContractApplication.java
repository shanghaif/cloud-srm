...
@EnableEurekaClient
@SpringBootApplication(scanBasePackages = {"com.midea.cloud.srm.cm", "com.midea.cloud.component","com.midea.cloud.log"})
@MapperScan(basePackages = {"com.midea.cloud.srm.cm.**.mapper"})
@EnableOpLog
