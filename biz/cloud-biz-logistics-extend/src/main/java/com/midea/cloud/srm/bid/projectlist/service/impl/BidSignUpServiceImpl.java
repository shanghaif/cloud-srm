...
import com.midea.cloud.srm.bid.projectlist.mapper.BidSignUpMapper;
...
import com.midea.cloud.srm.bid.purchaser.projectmanagement.bidinitiating.controller.BidingController;
...
import com.midea.cloud.srm.model.logistics.bid.suppliercooperate.vo.*;
...
public class BidSignUpServiceImpl extends ServiceImpl<BidSignUpMapper, SignUp> implements IBidSignUpService {
    ...
    @Resource
    private BidingController bidingController;
...
//                }
    ...
    public Map<String, String> getImportDicValueKey(Long bidingId) {
        ...
        // 报价币种
        List<BidBidingCurrency> bidBidingCurrencies = bidingController.getCurrencyByBidId(bidingId);
