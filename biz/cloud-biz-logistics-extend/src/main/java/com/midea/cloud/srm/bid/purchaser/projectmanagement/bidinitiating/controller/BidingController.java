...
import com.midea.cloud.srm.model.logistics.bid.purchaser.projectmanagement.bidinitiating.vo.SubmitApprovalVO;
...
//        }
    ...
    public void abandon(Long bidingId) {
        Assert.notNull(bidingId, "废弃招标单id不能为空");
    ...
    public Map<String, Object> getInitProjectParam(@RequestBody SubmitApprovalVO submitApprovalVO) {
        ...
        .eq(BidBidingCurrency::getBidingId,submitApprovalVO.getBidingId())
        )<=0){
     ...
     * @param
     * @return
     * @see com.midea.cloud.common.enums.bid.projectmanagement.projectpublish.BiddingApprovalStatus
     */
    ...
    public PageInfo<SourcingInfoVO> querySourcingInfo(@RequestBody SourcingInfoQueryDto queryDto) {
        ...
        if (Objects.equals(sourcingType, ClarifySourcingType.TENDER.getItemValue())) {
