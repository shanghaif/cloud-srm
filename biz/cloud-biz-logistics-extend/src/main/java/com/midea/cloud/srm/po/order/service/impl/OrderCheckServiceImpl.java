...
//        ));
//        //获取采购申请的 历史 订单
//        List<OrderDetail> dbHistoryOrderDetails = supcooperateClient.getOrderDetailByRequirementLineIds(requirementIds);
//        //获取采购申请的 历史  废弃订单id
//        Set<Long> abandonedSet = supcooperateClient.getOrderByIds(dbHistoryOrderDetails
...
//* 				总金额 -- 根据b表找到头表,用头表计算
    ...
    private void verifyTheOrderRelatedContract(List<OrderDetail> thisVerificationOrderDetails ,
        ...
        List<OrderDetail> historicalOrderDetails = supcooperateClient.listValidOrderDetail(thisVerificationOrderDetails);
