...
import com.midea.cloud.srm.bid.purchaser.projectmanagement.bidinitiating.mapper.*;
    ...
    public GenerateSourceFormResult generateForm(GenerateSourceFormParameter generateParameter) {
        ...
        biddingDao.useInterceptor()
                .beforeCreate(parameter -> parameter.getPrepareCreateEntity()
                        ...
                        .setBidUserName(currentUser.getNickname())
                        .setBidUserPhone(currentUser.getPhone())
                        .setBidUserEmail(currentUser.getEmail())
                )
                .save(bidding);
        //生成节点
