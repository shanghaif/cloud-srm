...
import com.midea.cloud.srm.model.logistics.bid.purchaser.projectmanagement.bidinitiating.enums.SourcingTemplateStatus;
...
public class SourcingTemplateServiceImpl implements ISourcingTemplateService {
        ...
        switch (SourcingType.get(sourcingTemplate.getSourcingType())) {
            case TENDER:
                return sourceFormService
                        .generateForm(com.midea.cloud.srm.model.logistics.bid.purchaser.projectmanagement.bidinitiating.vo.GenerateSourceFormParameter.builder()
    ...
    public List findQuoteAuthorizes(Long vendorId, Long templateId) {
        ...
        switch (SourcingType.get(sourcingTemplate.getSourcingType())) {
            //招标
            case TENDER:
                List<VendorPricingPermission> vendorPricingPermissions = bidIntelligentRecommendVendorService.getVendorPricingPermissions(sourceForm.getDemandLines(), new Long[]{vendorId}, null);
