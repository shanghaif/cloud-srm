package com.midea.cloud.srm.inq;
...
@EnableEurekaClient
@SpringBootApplication(scanBasePackages = {"com.midea.cloud.srm.inq", "com.midea.cloud.component",
        "com.midea.cloud.common.utils",
        "com.midea.cloud.common",
		"com.midea.cloud.log"})
@MapperScan(basePackages = {"com.midea.cloud.srm.inq.**.mapper"})
@EnableOpLog
