...
import com.midea.cloud.srm.price.estimate.mapper.EstimateFileMapper;
...
*/
@Service
public class EstimateFileServiceImpl extends ServiceImpl<EstimateFileMapper, EstimateFile> implements IEstimateFileService {
