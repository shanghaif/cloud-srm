...
@TableName("scc_sup_r8_discredit_guarantee")
public class R8DiscreditGuarantee extends BaseEntity {
     ...
     * 担保企业失信ID
     */
    @TableId("DISCREDIT_GUARANTEE_ID")
     ...
     * 担保企业失信标志（0：非失信，1：失信）
     */
    @TableField("GUARANTEE_DISCREDIT_FLAG")
    private String guaranteeDiscreditFlag;

    /**
     * 担保企业失信提示
     */
    @TableField("GUARANTEE_DISCREDIT_PROMPT")
