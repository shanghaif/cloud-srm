...
@TableName("scc_price_approval_ladder")
public class ApprovalLadderPrice extends BaseEntity {
     ...
     * 主键ID
     */
    @TableId("APPROVAL_PRICE_LADDER_ID")
    private Long approvalPriceLadderId;

    /**
     * 价格审批单明细行ID,关联价格审批单明细表ID
     */
