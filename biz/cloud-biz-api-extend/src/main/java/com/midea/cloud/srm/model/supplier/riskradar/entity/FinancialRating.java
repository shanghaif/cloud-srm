...
@TableName("scc_sup_financial_rating")
public class FinancialRating extends BaseEntity {
     ...
     * 财务评级ID
     */
    @TableId("FINANCIAL_RATING_ID")
    private Long financialRatingId;
    ...
    private BigDecimal assetLoadRatio;
    ...
    private BigDecimal netAssetProfitMargin;
