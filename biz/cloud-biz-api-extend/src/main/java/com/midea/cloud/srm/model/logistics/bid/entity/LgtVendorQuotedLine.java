...
@TableName("scc_lgt_vendor_quoted_line")
public class LgtVendorQuotedLine extends BaseEntity {
     ...
     * 供应商报价行ID
     */
    @TableId("QUOTED_LINE_ID")
    private Long quotedLineId;
     ...
     * 贸易术语
     */
    @TableField(value = "TRADE_TERM",updateStrategy = FieldStrategy.IGNORED)
     ...
     * 申请行号
     */
    @TableField("REQUIREMENT_LINE_NUM")
    private Long requirementLineNum;
     ...
     * 还价原因
     */
    @TableField("COUNTEROFFER_REASON")
    private String counterofferReason;
     ...
     * 运输距离调整
     */
    @TableField(value = "TRANSPORT_DISTANCE_REVISION",updateStrategy = FieldStrategy.IGNORED)
     ...
     * 物流招标项目需求ID
     */
    @TableId("BID_REQUIREMENT_LINE_ID")
