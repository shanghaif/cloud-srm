...
@TableName("scc_base_survey_scope_vendor")
public class SurveyScopeVendor extends BaseEntity {
private static final long serialVersionUID = 766924L;
 /**
 * 供应商范围ID
 */
 @TableId("VENDOR_SCOPE_ID")
