...
@TableName("scc_price_estimate_attr_line")
public class EstimateAttrLine extends BaseEntity {
     ...
     * 枚举值列
     */
    @TableField("ENUM_ATTRIBUTE_MAP")
    private String enumAttributeMap;
