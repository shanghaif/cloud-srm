...
@Data
@ColumnWidth(20)
public class PurchaseCategoryFiveExportDto implements PurchaseCategoryDto{
    /**
     * 分类名称
     */
     ...
     * 是否启用(Y启用 N未启用)
     */
    @ExcelProperty( value = {"三级","*是否启用(Y/N)"},index = 8)
    private String enabledThree;

    /**
     * 分类名称
     */
    @ExcelProperty( value = {"四级","*品类名称"},index = 9)
    private String categoryNameFour;

    /**
     * 分类编码
     */
    @ExcelProperty( value = {"四级","*品类编码"},index = 10)
    private String categoryCodeFour;

    /**
     * 是否启用(Y启用 N未启用)
     */
    @ExcelProperty( value = {"四级","*是否启用(Y/N)"},index = 11)
    private String enabledFour;

    /**
     * 分类名称
     */
    @ExcelProperty( value = {"五级","*品类名称"},index = 12)
    private String categoryNameFive;

    /**
     * 分类编码
     */
    @ExcelProperty( value = {"五级","*品类编码"},index = 13)
    private String categoryCodeFive;

    /**
     * 是否启用(Y启用 N未启用)
     */
    @ExcelProperty( value = {"六级","*是否启用(Y/N)"},index = 14)
    private String enabledFive;
