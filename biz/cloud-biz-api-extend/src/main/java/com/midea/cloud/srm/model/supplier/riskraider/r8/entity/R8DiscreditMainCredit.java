...
@TableName("scc_sup_r8_discredit_main_credit")
public class R8DiscreditMainCredit extends BaseEntity {
     ...
     * 主体拖欠贷款ID
     */
    @TableId("DISCREDIT_MAIN_CREDIT_ID")
    private Long discreditMainCreditId;
