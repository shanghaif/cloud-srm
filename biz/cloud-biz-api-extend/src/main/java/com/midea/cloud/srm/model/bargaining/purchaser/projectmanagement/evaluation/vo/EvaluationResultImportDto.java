package com.midea.cloud.srm.model.bargaining.purchaser.projectmanagement.evaluation.vo;
...
@Data
@ColumnWidth(20)
public class EvaluationResultImportDto implements Serializable {
    ...
    private String currentRoundMinPrice;
    ...
    private String	standardCurrencyPrice;

    @ExcelProperty( value = "本币未税价",index = 23)
    private String	standardCurrencyNoTaxPrice;
    ...
    @ExcelProperty( value = "配额(%)",index = 30)
