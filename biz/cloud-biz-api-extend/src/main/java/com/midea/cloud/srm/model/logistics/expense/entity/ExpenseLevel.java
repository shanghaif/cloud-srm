...
@TableName("scc_lgt_expense_level")
public class ExpenseLevel extends BaseEntity {
     ...
     * 费用级别定义ID
     */
    @TableId("EXPENSE_LEVEL_ID")
    private Long expenseLevelId;

    /**
     * 费用级别编码(字典编码SUB_LEVEL)
     */
    @TableField("SUB_LEVEL_CODE")
