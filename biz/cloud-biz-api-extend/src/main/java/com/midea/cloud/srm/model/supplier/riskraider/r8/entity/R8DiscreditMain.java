...
@TableName("scc_sup_r8_discredit_main")
public class R8DiscreditMain extends BaseEntity {
     ...
     * 主体企业失信标志（0：非失信，1：失信）
     */
    @TableField("MAIN_DISCREDIT_FLAG")
    private String mainDiscreditFlag;

    /**
     * 主体企业失信提示
     */
    @TableField("MAIN_DISCREDIT_PROMPT")
