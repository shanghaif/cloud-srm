...
@TableName("ceea_itf_inv_organizations")
public class InvOrganization extends BaseEntity {
     ...
     * 库存组织ID
     */
    @TableField("ES_INV_ORGANIZATION_ID")
    private String esInvOrganizationId;

    /**
     * 库存组织编码
     */
    @TableField("ES_INV_ORGANIZATION_CODE")
    private String esInvOrganizationCode;

    /**
     * 库存组织名称
     */
    @TableField("INV_ORGANIZATION_NAME")
    ...
    @TableField("ES_LOCATION_NAME")
    private String esLocationName;
