...
@TableName("scc_sup_risk_responses")
public class Responses extends BaseEntity {
     ...
     * 风险监控Id
     */
    @TableId("RISK_RESPONSES_ID")
    private Long riskResponsesId;

    /**
     * 风险监控Id
     */
    @TableField("RISK_MONITORING_ID")
    private Long riskMonitoringId;

    /**
     * 应对措施类型
     */
    @TableField("RESPONSES_TYPE")
     ...
     * 上期应对措施
     */
    @TableField("FIRST_RESPONSE_MEASURES")
    private String firstResponseMeasures;
