...
@TableName("scc_lgt_requirement_line")
public class LogisticsRequirementLine extends BaseEntity {
     ...
     * 指定供应商编码
     */
    @TableField("SPECIFIED_VENDOR_CODE")
    private String specifiedVendorCode;
