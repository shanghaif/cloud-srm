...
@TableName("scc_sup_dim_field_context_change")
public class DimFieldContextChange extends BaseEntity {
     ...
     * 属性内容变更ID
     */
    @TableId("FIELD_CONTEXT_CHANGE_ID")
    private Long fieldContextChangeId;
     ...
     * 关联内容ID
     */
    @TableField("CONTEXT_CHANGE_ID")
    private Long contextChangeId;

    /**
     * 变更ID
     */
    @TableField("FIELD_CHANGE_ID")
    private Long fieldChangeId;

    /**
     * 属性内容ID
     */
    @TableField("FIELD_CONTEXT_ID")
