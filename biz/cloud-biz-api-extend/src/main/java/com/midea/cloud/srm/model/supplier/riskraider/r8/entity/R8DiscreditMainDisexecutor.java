...
@TableName("scc_sup_r8_discredit_main_disexecutor")
public class R8DiscreditMainDisexecutor extends BaseEntity {
     ...
     * 主体失信被执行人ID
     */
    @TableId("DISCREDIT_MAIN_DISEXECUTOR_ID")
    private Long discreditMainDisexecutorId;
