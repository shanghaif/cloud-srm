...
@TableName("scc_sup_r8_discredit_relation")
public class R8DiscreditRelation extends BaseEntity {
     ...
     * 关联企业失信标志（0：非失信，1：失信）
     */
    @TableField("RELATION_DISCREDIT_FLAG")
    private String relationDiscreditFlag;

    /**
     * 关联企业失信提示
     */
    @TableField("RELATION_DISCREDIT_PROMPT")
