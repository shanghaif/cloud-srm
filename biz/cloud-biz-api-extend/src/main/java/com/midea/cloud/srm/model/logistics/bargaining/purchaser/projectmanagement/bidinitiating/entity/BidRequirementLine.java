...
@TableName("scc_brg_requirement_line")
public class BidRequirementLine {
    /**
     * 需求行主键ID
     */
    @TableId("REQUIREMENT_LINE_ID")
    private Long sourceRequirementLineId;
     ...
     * 采购申请行id
     */
    @TableId("PURCHASE_REQUIREMENT_LINE_ID")
    private Long requirementLineId;

    /**
     * 采购需求编号(申请编号)
     */
    @TableField("PURCHASE_REQUIREMENT_HEAD_NUM")
