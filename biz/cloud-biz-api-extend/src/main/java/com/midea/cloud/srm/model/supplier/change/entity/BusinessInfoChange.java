...
@TableName("scc_sup_business_info_change")
public class BusinessInfoChange extends BaseEntity {
     ...
     * 财务信息变更表ID
     */
    @TableId("BUSINESS_CHANGE_ID")
    private Long businessChangeId;
