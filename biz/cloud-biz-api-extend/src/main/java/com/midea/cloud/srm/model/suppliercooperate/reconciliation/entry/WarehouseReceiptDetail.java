...
@TableName("scc_sc_warehouse_receipt_detail")
public class WarehouseReceiptDetail extends BaseEntity {
    private static final long serialVersionUID = 1L;

    /**
     * 入库单明细id
     */
    @TableId("WAREHOUSE_RECEIPT_DETAIL_ID")
