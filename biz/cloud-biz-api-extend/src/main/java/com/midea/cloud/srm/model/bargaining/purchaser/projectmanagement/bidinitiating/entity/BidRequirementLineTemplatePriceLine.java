package com.midea.cloud.srm.model.bargaining.purchaser.projectmanagement.bidinitiating.entity;
...
@Data
@TableName("ceea_brg_req_line_templprice_l")
public class BidRequirementLineTemplatePriceLine extends BaseEntity {

    @TableId("ID")
    private Long        id;                     // 表ID

    @TableField("HEADER_ID")
    private Long        headerId;               // 寻源需求行[模型报价]明细头ID
