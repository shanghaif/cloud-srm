...
@TableName("ceea_sc_online_invoice_punish")
public class OnlineInvoicePunish extends BaseEntity {
     ...
     * 主键,网上开票扣罚返利明细ID
     */
    @TableId("ONLINE_INVOICE_PUNISH_ID")
    private Long onlineInvoicePunishId;

    /**
     * 开票通知扣罚返利明细ID
     */
    @TableField("INVOICE_PUNISH_ID")
