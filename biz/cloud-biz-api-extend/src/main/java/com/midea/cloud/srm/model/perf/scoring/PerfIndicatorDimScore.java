...
@TableName("scc_perf_indicator_dim_score")
public class PerfIndicatorDimScore extends BaseEntity {

    private static final long serialVersionUID = 1L;

    /**综合绩效得分明细表集合*/
    @TableField(exist = false)
    private List<PerfIndDimScoreDetail> perfIndDimScoreDetailList;

    /**
     * 主键ID
     */
    @TableId("INDICATOR_DIM_SCORE_ID")
    ...
    /**指标维度绩效得分主表ID OVERALL_SCORE*/
    @TableField("OVERALL_SCORE_ID")
