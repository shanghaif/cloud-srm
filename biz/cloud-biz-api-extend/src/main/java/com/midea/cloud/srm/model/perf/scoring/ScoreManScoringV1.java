...
public class ScoreManScoringV1 extends BaseEntity {
    ...
    /**
     * 项目状态(SCORE_DRAFT:拟定,SCORE_CALCULATED:已计算评分)
     */
    @TableField("STATUS")
     ...
     * 绩效评分项目表-创建人账号
     */
    @TableField("SCORE_ITEMS_CREATED_USERNAME")
    private String scoreItemsCreatedUsername;

    /**
     * 绩效评分项目表-创建人昵称
     */
    @TableField("SCORE_ITEMS_CREATED_NICKNAME")
    private String scoreItemsCreatedNickname;
     ...
     * 项目已计算评分
     */
    @TableField("IF_END_SCORED")
    private String ifEndScored;
     ...
     * 是否Excel导入并需要刷新（默认N）
     */
    @TableField("IF_EXCEL_IMPORT")
    private String ifExcelImport;

    /**
     * Excel导入后是否刷新状态（默认N）
     */
    @TableField("IF_FRESH_AFTER_IMPORT")
    private String ifFreshAfterImport;
     ...
     */
    @TableField(exist = false)
    private String ifQueryByScoreItemsCreatedBy;
    ...
    public String getUniqueKey() {
        ...
        sb.append(getScoreItemsId())
                .append("-").append(getOrganizationId())
                .append("-").append(getCompanyId())
                .append("-").append(getDimWeightId())
                .append("-").append(getTemplateLineId());
        return sb.toString();
    }

    @TableField(exist = false)
    private List<IndicatorsLine> indicatorsLines;
