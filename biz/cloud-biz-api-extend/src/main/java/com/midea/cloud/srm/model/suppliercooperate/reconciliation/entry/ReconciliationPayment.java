...
@TableName("scc_sc_reconciliation_payment")
public class ReconciliationPayment extends BaseErrorCell {
     ...
     * 付款金额
     */
    @TableField("PAYMENT_NOTE_NUMBER")
    private String paymentNoteNumber;
