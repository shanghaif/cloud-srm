...
public class ContractLine extends BaseEntity {
     ...
     * 合同模板行信息ID
     */
    @TableField("TEMPL_LINE_ID")
    private Long templLineId;
     ...
     * 是否可显示
     */
    @TableField("IS_DISPLAYED")
    private String isDisplayed;

    /**
     * 合同模板内容
     */
    @TableField("TEMPL_CONTENT")
