...
@TableName("scc_ps_payment_plan_line")
public class PaymentPlanLine extends BaseEntity {

	private static final long serialVersionUID = 7489127367739507738L;

	/**
	 * 主键ID
	 */
	@TableId("PAYMENT_PLAN_LINE_ID")
