...
@TableName("scc_sc_invoice_notice_receipt")
public class InvoiceNoticeReceipt extends BaseEntity {
     ...
     * 主键,开票通知入库明细ID
     */
    @TableId("NOTICE_RECEIPT_ID")
    private Long noticeReceiptId;
     ...
     * 实际开票金额
     */
    @TableField("ACTUAL_INVOICE_AMOUNT")
