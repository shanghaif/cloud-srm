package com.midea.cloud.srm.model.bid.purchaser.projectmanagement.techscore.entity;
...
@TableName("scc_bid_tech_score_line")
public class TechScoreLine extends BaseEntity {
	...
	/**
	 * 招标评分规则明细表ID,scc_bid_score_rule_line
	 */
