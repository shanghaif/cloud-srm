...
@TableName("scc_sup_r8_discredit_main_loan")
public class R8DiscreditMainLoan extends BaseEntity {
     ...
     * 主体拖欠借款ID
     */
    @TableId("DISCREDIT_MAIN_LOAN_ID")
    private Long discreditMainLoanId;
