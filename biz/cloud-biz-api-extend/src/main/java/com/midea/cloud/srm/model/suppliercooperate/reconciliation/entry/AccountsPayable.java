...
@TableName("scc_sc_accounts_payable")

public class AccountsPayable extends BaseErrorCell {
    private static final long serialVersionUID = 1L;

    /**
     * 主键ID
     */
    @TableId("ACCOUNTS_PAYABLE_ID")
     ...
     * 本期付款
     */
    @TableField("CURRENT_PAY")
    private BigDecimal currentPay;

    /**
     * 本期冲销额
     */
    @TableField("CHARGE_AGAINST")
    private BigDecimal chargeAgainst;
