...
@TableName("scc_bid_order_line1")
public class DataTransferBidOrderLine1 extends BaseEntity {
     ...
     * 系统计算的配额比例
     */
    @TableField("CEEA_SOURCE_QUOTA_RATIO")
    private BigDecimal ceeaSourceQuotaRatio;
