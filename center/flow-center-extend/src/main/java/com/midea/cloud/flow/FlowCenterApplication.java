 ...
 *  修改后版本:
 *  修改人:
 *  修改日期: 2020-3-10 17:19
 *  修改内容:
 * </pre>
 */
@EnableFeignClients("com.midea.cloud.srm.feign")
@EnableEurekaClient
@SpringBootApplication(scanBasePackages = {"com.midea.cloud.flow", "com.midea.cloud.component"})
@MapperScan(basePackages = {"com.midea.cloud.flow.**.mapper"})
@EnableOpLog
