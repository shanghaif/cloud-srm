...
public class SrmSysMsignCallBackConDto {
    private Long msignCallBackConId; //主键ID
    private Long msignCallBackId; //新增智慧签约合同头表ID
    private String attchmentId; //附件ID，原值回传
    private String signAttchmentId; //已盖章文件ID
    private String signUrl; //已盖章文件下载URL
    private String signStatus; //已盖章状态
    private String sourceFileName; //源文件名称、原值回传
    private String sourceFileNumber; //源文件ID、原值回传
    ...
    public Long getMsignCallBackConId() {
        return msignCallBackConId;
    }

    public void setMsignCallBackConId(Long msignCallBackConId) {
        this.msignCallBackConId = msignCallBackConId;
    }
    ...
    public String getSignAttchmentId() {
        return signAttchmentId;
    }

    public void setSignAttchmentId(String signAttchmentId) {
        this.signAttchmentId = signAttchmentId;
    }
    ...
    public String getSourceFileNumber() {
        return sourceFileNumber;
    }

    public void setSourceFileNumber(String sourceFileNumber) {
